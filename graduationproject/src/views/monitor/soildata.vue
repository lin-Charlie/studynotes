  ...
  <div class="container">
    <div class="search-wrapper">
      <div class="params">
        ...
        <el-input
        class="marginRight"
        v-model="searchParams.landOwner"
        clearable
        placeholder="土地所有者"
        >
        </el-input>
    ...
    <div class="dialog">
      <soil-data-dialog @save="getTableData" ref="soilDataDialog"></soil-data-dialog>
    </div>
  </div>
</template>

<script type='text/ecmascript-6'>
import { soilInfoTable } from "@/config/table/monitor";
import GislifePagination from "@/components/GislifePagination";
import GislifeTable from "@/components/GislifeTable";
import soilDataDialog from "./dialog/soildataDialog.vue"
export default {
  components: {
    GislifeTable,
    GislifePagination,
  ...
  methods: {
    ...
    openDialog(type, title, row, index) {
      ...
      this.$refs.soilDataDialog.openDialog(obj);
    },
